            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="group flex w-full items-center justify-center gap-2 rounded-xl bg-zinc-900 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-zinc-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-900 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
      ...
      <div className="hidden lg:block lg:flex-1 relative bg-zinc-900 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center text-white">
          ...
          <h2 className="text-4xl font-bold tracking-tight mb-4 max-w-lg">
            "WellnessZ helped us increase lead conversion by 34% in just two weeks."
          </h2>
